...
bool CDlgServerItem::GetModuleInitParameter(tagGameServerInfo * pGameServerInfo, bool bAutoMode)
{
	...
	m_ModuleInitParameter.GameServiceOption.lMinEnterTiLi=pGameServerInfo->lMinEnterTiLi;
	...
	m_ModuleInitParameter.GameServiceOption.wAndroidCount=pGameServerInfo->wAndroidCount;
	...
	m_ModuleInitParameter.GameServiceOption.dwRoomID=pGameServerInfo->dwRoomID;
	m_ModuleInitParameter.GameServiceOption.wRoomKind=pGameServerInfo->wRoomKind;
	m_ModuleInitParameter.GameServiceOption.wRoomType=pGameServerInfo->wRoomType;
	m_ModuleInitParameter.GameServiceOption.wBloodIndex=pGameServerInfo->wBloodIndex;
	m_ModuleInitParameter.GameServiceOption.dwBloodScore=pGameServerInfo->dwBloodScore;
	_stprintf(m_ModuleInitParameter.GameServiceOption.szServerName,TEXT("%s-%s"),pGameServerInfo->szGameName,pGameServerInfo->szServerName);

	m_ModuleInitParameter.GameServiceOption.wLockPoint=pGameServerInfo->wLockPoint;
	m_ModuleInitParameter.GameServiceOption.wCardBoxIndex=pGameServerInfo->wCardBoxIndex;
	m_ModuleInitParameter.GameServiceOption.wRankIndex=pGameServerInfo->wRankIndex;
	m_ModuleInitParameter.GameServiceOption.wRankTime=pGameServerInfo->wRankTime;
	m_ModuleInitParameter.GameServiceOption.wRewardExp=pGameServerInfo->wRewardExp;
	m_ModuleInitParameter.GameServiceOption.wCashIn=pGameServerInfo->wCashIn;
	m_ModuleInitParameter.GameServiceOption.wRoomTimeOut=pGameServerInfo->wRoomTimeOut;
	m_ModuleInitParameter.GameServiceOption.cbIsKickOut=pGameServerInfo->cbIsKickOut;
	m_ModuleInitParameter.GameServiceOption.cbIsSendRed=pGameServerInfo->cbIsSendRed;
...
{
	//获取选择
	ASSERT_ERR(m_ServerListControl.GetFirstSelectedItemPosition()!=NULL);
	POSITION Position=m_ServerListControl.GetFirstSelectedItemPosition();
