...
protected:
	...
	//tagDataBaseParameter			m_BillboardDBParameter;				//连接信息
...
public:
	...
	//连接信息
	//tagDataBaseParameter * GetBillboardDBParameter() { return &m_BillboardDBParameter; }

	//连接信息
	VOID SetPlatformDBParameter(tagDataBaseParameter & PlatformDBParameter) { m_PlatformDBParameter=PlatformDBParameter; }

	//排行榜连接信息
	//VOID SetBillboardDBParameter(tagDataBaseParameter & BillboardDBParameter) { m_BillboardDBParameter=BillboardDBParameter; }
