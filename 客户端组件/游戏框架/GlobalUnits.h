...
#define	MODULE_MATCH_FRAME_CONTROL  16									//比赛框架

//模块索引
typedef CMap<WORD,WORD,IUnknownEx *,IUnknownEx * &> CGlobalModuleMap;

typedef CMap<WORD,WORD,IPC_GF_LayerWndInfo,IPC_GF_LayerWndInfo> LayerWndInfoMap;
...
public:
	...
	std::deque<IPC_GR_PropertyNoticeMsg>		m_notifyMsg;					//标题栏滚动消息
	bool																m_notify;						//消息到来

	LayerWndInfoMap								m_LayerWndMap;	
