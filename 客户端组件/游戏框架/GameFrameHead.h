...
public:
	...
	//大厅事件
	virtual bool IsWebPlazaReady()=NULL;
	//用户道具接口
	virtual tagGameItemInfo* GetUserItemInfo(enUserItem enUI)=NULL;
};
...
public:
	...
	//用户任务
	virtual VOID OnUserTaskUpdate(IClientUserItem * pIClientUserItem, bool bLookonUser)=NULL;
};
...
public:
	...
	virtual bool OnGameOptionChange()=NULL;
	//分层句柄
	virtual bool SetGameLayerHandle(IPC_GF_LayerWndInfo& LayerWndInfo)=NULL;
};
...
public:
	...
	//显示控制
	virtual VOID SetUserListControl(bool bShow=true)=NULL;
};

//////////////////////////////////////////////////////////////////////////////////

#ifdef _UNICODE
#define VER_IMatchFrameControl INTERFACE_VERSION(1,1)
static const GUID IID_IMatchFrameControl={0x9A50C0B7,0x567F,0x4320,0x87,0x93,0x32,0x1D,0x30,0x8B,0x0B,0x22};
#else
#define VER_IMatchFrameControl INTERFACE_VERSION(1,1)
static const GUID IID_IMatchFrameControl={0xDA235202,0x1CD2,0x4E4E,0x9C,0xDA,0xEF,0xBC,0xCD,0xC8,0x42,0x17};
#endif

//比赛框架
interface IMatchFrameControl : public IUnknownEx
{
	//控制接口
public:
	virtual VOID SetMatchViewInfo(tagMatchViewInfo* pMatchViewInfo)=NULL;
};
//////////////////////////////////////////////////////////////////////////////////
