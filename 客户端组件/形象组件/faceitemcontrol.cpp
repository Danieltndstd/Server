...
CPngImage          CFaceItemControl::m_UserImageFace[201];
//////////////////////////////////////////////////////////////////////////////////
...
CFaceItemControl::CFaceItemControl()
{
	...
	for (INT i=0;i<202;i++)
	{
		...
		m_UserImageFace[i].LoadImage(hResInstance,str);
	}
...
VOID CFaceItemControl::DrawFaceNormal(CDC * pDC, INT nXPos, INT nYPos, INT nWidth, INT nHeight, WORD wFaceID)
{
	...
	m_UserImageFace[wFaceID].DrawImage(pDC,nXPos,nYPos,nWidth,nHeight,0,0,FACE_CX,FACE_CY);
