...
VOID CInitParameter::InitParameter()
{
	...
	//ZeroMemory(&m_BillboardDBParameter, sizeof(m_BillboardDBParameter));
...
VOID CInitParameter::LoadInitParameter()
{
	...
	/*
	//连接信息
	m_BillboardDBParameter.wDataBasePort=(WORD)IniData.ReadInt(TEXT("PlatformDB"),TEXT("DBPort"),1433);
	IniData.ReadEncryptString(TEXT("PlatformDB"),TEXT("DBAddr"),NULL,m_BillboardDBParameter.szDataBaseAddr,CountArray(m_BillboardDBParameter.szDataBaseAddr));
	IniData.ReadEncryptString(TEXT("PlatformDB"),TEXT("DBUser"),NULL,m_BillboardDBParameter.szDataBaseUser,CountArray(m_BillboardDBParameter.szDataBaseUser));
	IniData.ReadEncryptString(TEXT("PlatformDB"),TEXT("DBPass"),NULL,m_BillboardDBParameter.szDataBasePass,CountArray(m_BillboardDBParameter.szDataBasePass));
	IniData.ReadEncryptString(TEXT("PlatformDB"),TEXT("DBName"),szBillboardDB,m_BillboardDBParameter.szDataBaseName,CountArray(m_BillboardDBParameter.szDataBaseName));
	*/
