...
protected:
	...
	tagUserTaskList					m_UserTaskList;						//任务列表
...
public:
	//获取任务
	virtual tagUserTaskList*  GetUserTaskList(){return &m_UserTaskList;};
	//获取任务
	virtual tagUserTaskInfo* GetUserTaskInfo(enTaskKind enTK);
};
...
public:
	...
	//更新任务
	virtual bool UpdateUserTaskList(IClientUserItem * pIClientUserItem, tagUserTaskList * pUserTaskList);
