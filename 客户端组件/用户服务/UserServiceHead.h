...
public:
	//获取任务
	virtual tagUserTaskList*  GetUserTaskList()=NULL;
	//获取任务
	virtual tagUserTaskInfo* GetUserTaskInfo(enTaskKind enTK)=NULL;
};
...
interface IUserManagerSink : public IUnknownEx
{
	...
	//用户任务
	virtual VOID OnUserTaskUpdate(IClientUserItem * pIClientUserItem)=NULL;
};
...
public:
	...
	//更新任务
	virtual bool UpdateUserTaskList(IClientUserItem * pIClientUserItem, tagUserTaskList * pUserTaskList)=NULL;
...
public:
	...
	//用户等级
	virtual WORD GetUserLevelItem(IClientUserItem * pIClientUserItem)=NULL;
