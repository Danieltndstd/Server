...
#include "zlreactor/json/value.h"
#include "zlreactor/json/reader.h"
#include "zlreactor/json/writer.h"
#include <conio.h> 
//////////////////////////////////////////////////////////////////////////
//枚举定义
...
public:
	ConnectType						m_ConnectType;						//连接类型	
...
private:
	...
	bool WS_HandShake(zl::net::ByteBuffer* ByteBuffer);
	bool WS_SendRawData(const char* data, int len);
	bool WS_HandleWebSocketRecv();
};
