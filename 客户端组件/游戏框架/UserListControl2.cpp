#include "StdAfx.h"
#include "Resource.h"
#include "..\..\客户端组件\游戏控件\UserItemElement.h"
...
CImageList			CUserListControl2::m_ImageUserStatus;				//状态位图

//////////////////////////////////////////////////////////////////////////////////

BEGIN_MESSAGE_MAP(CUserListControl2, CSkinListCtrlEx)
	ON_WM_NCDESTROY()
END_MESSAGE_MAP()
...
//构造函数
CUserListControl2::CUserListControl2()
{
	//资源变量
	m_dwMySelfUserID=0L;
	m_bAscendSort=false;
...
//控件绑定
VOID CUserListControl2::PreSubclassWindow()
{
	...
	if (m_ImageUserStatus.m_hImageList==NULL)
	{
		...
		Image.LoadBitmap(3013);//IDB_USER_STATUS_IMAGE
...
//获取位置
INT CUserListControl2::GetInsertIndex(VOID * pItemData)
{
	//变量定义
...
//排列数据
INT CUserListControl2::SortItemData(LPARAM lParam1, LPARAM lParam2, WORD wColumnIndex, bool bAscendSort)
{
	//定义变量
...
//先锋科技:Q群8990607
//描述字符
VOID CUserListControl2::ConstructString(VOID * pItemData, WORD wColumnIndex, LPTSTR pszString, WORD wMaxCount)
{
	//效验参数
...
//获取颜色
VOID CUserListControl2::GetItemColor(LPDRAWITEMSTRUCT lpDrawItemStruct, COLORREF&crColorText, COLORREF&crColorBack)
{
	//定制变量
...
//绘画数据
VOID CUserListControl2::DrawCustomItem(CDC * pDC, LPDRAWITEMSTRUCT lpDrawItemStruct, CRect&rcSubItem, INT nColumnIndex)
{
	//参数效验
...
//先锋科技:Q群8990607
//解释用户
IClientUserItem * CUserListControl2::GetClientUserItem(VOID * pItemData)
{
	return (IClientUserItem *)pItemData;
}

//设置接口
bool CUserListControl2::SetServerRule(DWORD dwServerRule)
{
...
//设置接口
bool CUserListControl2::SetMySelfUserID(DWORD dwMySelfUserID)
{
	//设置变量
...
//设置接口
bool CUserListControl2::SetGameLevelParser(IUnknownEx * pIUnknownEx)
{
	//设置接口
	if (pIUnknownEx!=NULL)
	{
...
//设置接口
bool CUserListControl2::SetGameUserManager(IUnknownEx * pIUnknownEx)
{
	//设置接口
	if (pIUnknownEx!=NULL)
	{
...
//设置颜色
bool CUserListControl2::SetColorUserList(tagColorUserList&ColorUserList)
{
	//设置变量
...
//设置列表
bool CUserListControl2::SetColumnDescribe(tagColumnItem ColumnItem[], WORD wColumnCount)
{
	//构造判断
...
//销毁消息
VOID CUserListControl2::OnNcDestroy()
{
	//资源变量
	m_dwMySelfUserID=0L;
	m_bCreateColumn=false;
