...
//默认颜色
#define COLOR_SELECT_TX				RGB(217,206,142)			//字体颜色
#define COLOR_SELECT_BK				RGB(0,0,0)					//背景颜色
#define COLOR_NORMAL_TX				RGB(217,206,142)			//字体颜色
#define COLOR_NORMAL_BK				RGB(1,15,26)				//背景颜色

//默认颜色
#define COLOR_MYSELF_TX				RGB(217,206,142)					//字体颜色
#define COLOR_MYSELF_BK				RGB(1,15,26)					//背景颜色
#define COLOR_MASTER_TX				RGB(0,0,0)					//字体颜色
#define COLOR_MASTER_BK				RGB(1,15,26)					//背景颜色
#define COLOR_MEMBER_TX				RGB(0,0,0)					//字体颜色
#define COLOR_MEMBER_BK				RGB(1,15,26)					//背景颜色
