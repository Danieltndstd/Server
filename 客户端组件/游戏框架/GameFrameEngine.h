...
protected:
	...
	//播放窗口
protected:
	CDlgRecordPlayZJG*			m_pGlobalRecordDlg;

	//静态变量
protected:
	static CGameFrameEngine *		m_pGameFrameEngine;					//引擎接口
public:
	static bool							m_bDXSound;
...
public:
	...
	bool StopSound();
	//停止声音
	bool StopSound(LPCTSTR pszSoundName);
...
public:
	//创建或者显示视频控制对话框
	void ShowRecordDlg(vector<UINT>& vElapsed, CWnd* pParent = nullptr);
	//初始化DSound
