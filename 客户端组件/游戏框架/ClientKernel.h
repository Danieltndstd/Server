...
protected:
	...
	SCORE							m_lCellScore;						//房间低分
	WORD							m_ServerTypeEx;						//房间类型
...
protected:
	HANDLE							m_hWebPlaza;						//Web大厅句柄
	tagGameItemList					m_GameItemList;
...
public:
	...
	//用户任务
	virtual VOID OnUserTaskUpdate(IClientUserItem * pIClientUserItem);
...
public:
	virtual tagGameItemInfo* GetUserItemInfo(enUserItem enUI);
};
